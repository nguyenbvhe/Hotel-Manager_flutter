...
class MockData {
  ...
  static List<Room> rooms = [
    ...
    Room(
      ...
      price: 18000000,
      status: RoomStatus.available,
      description: 'Chairman Presidential Suite – Đỉnh cao của sự quyền quý. Với diện tích lên tới 150m², căn suite sở hữu phòng khách đại sảnh, khu vực dùng bữa riêng tư và quầy bar sang trọng. Nơi đây không chỉ là phòng nghỉ, mà là một biểu tượng của sự thành đạt và xa hoa bậc nhất G-Hotel.',
  ...
  static List<HotelService> services = [
    ...
    HotelService(
      id: 's3',
      name: 'Spa by G Special (90 phút)',
      price: 2.500000,
      description: 'Đánh thức mọi giác quan tại Spa by G – ốc đảo yên bình trên tầng cao nhất. Sử dụng tinh dầu cao cấp và kỹ thuật massage kết hợp Đông – Tây, liệu trình giúp giải tỏa căng thẳng toàn diện và tái tạo năng lượng từ sâu bên trong cơ thể.',
    ...
    HotelService(
      ...
      price: 4.500000,
      description: 'Đỉnh cao ẩm thực Pháp ngay tại G-Hotel. French Grill mang đến thực đơn nghệ thuật với những nguyên liệu xa xỉ nhất như gan ngỗng, nấm Truffle và rượu vang ủ lâu năm. Một không gian lãng mạn dưới ánh nến, dành riêng cho những dịp kỷ niệm quan trọng hay những buổi tối thăng hoa vị giác.',
